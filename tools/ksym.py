...
def BuildWithKSym(env, target, objects, end_building):
    ...
    target_root, target_ext = os.path.splitext(target_name)
    pre1_name = target_root + '.pre1' + target_ext
    pre2_name = target_root + '.pre2' + target_ext
    table1_name = target_root + '.ksym.pre1.c'
    table2_name = target_root + '.ksym.final.c'
    object1_name = target_root + '.ksym.pre1.o'
    object2_name = target_root + '.ksym.final.o'
